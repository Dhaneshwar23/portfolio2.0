...
export default function Skills({ Skills }: Props) {
    return (
        <>
        <div className='sm:items-start md:items-start xs:w-[190%] items-center'>
            <h2 className='font-bold text-8xl mt-40 text-center mb-20 md:text-6xl md:mt-32 xs:mb-20'>Skills</h2>
