...
export default function HireMe({ }: Props) {
    ...
    overflow-hidden md:right-8 md:left-auto md:top-0 sm:right-4 md:bottom-auto md:absolute'>
            <div className='w-48 h-auto flex item-center justify-center relative ms:w-24'>
                <Image src={TextSvg} alt={''} className='fill-dark animate-spin-slow dark:fill-light'></Image>

                <Link href='/' className='flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark
